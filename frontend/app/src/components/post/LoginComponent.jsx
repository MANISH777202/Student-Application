...
class LoginComponent extends Component {
  ...
  componentDidMount() {
    if (AuthenticationService.isUserLoggedIn()) {
      window.location.href =
        "/welcome/" + sessionStorage.getItem(USER_NAME_SESSION_ATTRIBUTE_NAME);
    }
  }
  ...
  handleRegister(values) {
    AuthenticationService.registerNewAccount(values.username, values.password)
      .then((response) => {
      ...
      <div className="App">
        <div className="LoginComponent">
          <div className="Description">
            ...
            <p>
              A fully-responsive, social media built for students with{" "}
              <b>ReactJS</b>,<b> Springboot</b>, <b>Maven</b>, <b>MySQL</b>.{" "}
              <br />
              <br />
            </p>
          </div>
          ...
          >
            ...
            <p>
              The credentials you put in just now is <code>Invalid</code>.
              Please try again.
            </p>
          </Alert>
          ...
          <Alert
            className={"fix-alert"}
            show={this.state.registerFailShow}
            variant={"danger"}
            onClose={() => this.setRegisterFailShow(false)}
            dismissible
          >
            <Alert.Heading>Hmmm! We got a problem</Alert.Heading>
            <p>
              It could be invalid credential. Or we ran out of money to host the
              backend :(.
            </p>
          </Alert>
          ...
          <Alert
            className={"fix-alert"}
            show={this.state.registerSuccessShow}
            variant={"success"}
            onClose={() => this.setRegisterSuccessShow(false)}
            dismissible
          >
